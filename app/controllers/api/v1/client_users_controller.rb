...
def create
    ...
    @client_user = ClientUser.create(name: params[:name], email: params[:email],password_digest: params[:password_digest],client_id: params[:client_id], client_role_id: @client_role.id)
     if @client_user.save
      # @client_user.update(client_id: params[:client_id], client_role_id: @client_role.id)
